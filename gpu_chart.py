...
class GpuChart(ft.LineChart):
    def __init__(self):
        ...
        self.data_series = [
            ...
            ft.LineChartData(
                ...
                stroke_cap_round=True,
                curved=True,
                below_line_bgcolor=ft.colors.with_opacity(0.2,'red'),
                prevent_curve_over_shooting=True
            )
    ...
    def update_data(self, x, gpu_utilization,temp):
        ...
        if len(self.data_series[1].data_points) > 20:
            ...
            self.max_x = x
        self.data_series[1].data_points.append(
            ft.LineChartDataPoint(x, temp))
        self.min_x = self.data_series[1].data_points[0].x